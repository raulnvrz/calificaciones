  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <br>
            ...
            <a href="#" onclick="document.forms['excel'].submit(); return false;" class="d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cargar excel</a>
                    ...
                    <?php 
                      if(isset($_FILES['excelfile'])){
                        ...
                        $mimes = array('text/x-comma-separated-values', 'text/comma-separated-values', 'application/octet-stream', 'application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');

                        if(in_array($_FILES["excelfile"]["type"],$mimes)){
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <?php
                        foreach($alumnos->get_max_min("max") as $val){
                          print '<div class="text-xs font-weight-bold text-default mb-1">'.$val["student"].'</div>';
                          $best_rating = $val["rating"];
                        }

                        ?>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php print $best_rating; ?></div>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <?php
                        foreach($alumnos->get_max_min("min") as $val){
                          print '<div class="text-xs font-weight-bold text-default mb-1">'.$val["student"].'</div>';
                          $worst_rating = $val["rating"];
                        }

                        ?>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php print $worst_rating; ?></div>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php print number_format($alumnos->get_average("total"),1) ?></div>
                      </div>
          ...
          <?php
            print '<textarea id="data_chart" style="display:none;">'.json_encode($alumnos->get_average("grades")).'</textarea>';
          ...
          ?>
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ejercicio</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_posting_photo.svg" alt="">
                  </div>
                  <p>Sistema para carga de excel con calificaciones, para el muestreo de calificaciones en graficas, obtención de promedio por grado, mejor calificación, peor calificación y el promedio total.</p>
                  <p>- Cargar el archivo xlsx en la parte superior para obtener los resultados.</p>
                </div>
              </div>
